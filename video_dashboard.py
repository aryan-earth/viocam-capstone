# Find vehicles in an frame and return cropped out frame of every vehicle detected in that frame.
...
while video.isOpened():
    ...
    #todo uncomment this later
    try:
        top_four_vehicles_image = get_top_four_vehicles(vehicles_positions, frame)
    except Exception as exc:
        top_four_vehicles_image = cv.resize(frame, (1000,1000))
    ...
    result = np.hstack([license_plate_detection_image, vehicle_detection_image, helmet_detection_image])
